...
const Dashboard = () => (
  <div className="space-y-6">
    <div className="flex justify-between items-center">
      ...
      <div className="text-[10px] font-black text-green-700 bg-green-50 px-3 py-1.5 rounded-xl uppercase tracking-widest border border-green-100 shadow-sm">Season 2024</div>
    </div>
